...
// FIX: Replaced `express.Response` and `express.NextFunction` with direct type imports.
...
// FIX: Use Response and NextFunction types from express to resolve property access errors.
